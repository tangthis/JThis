...
<base href="<%=basePath%>">
<meta charset="utf-8"/>
<title>登录到 Spring_Mybatis_Shiro</title>
	...
	<form class="login-form" action="user/login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="uname" id="uname" size="25" value="admin" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="pwd" id="pwd" size="25" value="123456" class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" />
			</div>
		</div>
